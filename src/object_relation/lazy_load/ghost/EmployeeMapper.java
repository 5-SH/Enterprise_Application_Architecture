...
public class EmployeeMapper extends Mapper {
  ...
  protected void doLoadLine(ResultSet rs, DomainObject obj) {
    try {
      ...
      DepartmentMapper departmentMapper = (DepartmentMapper) MapperRegistry.mapper("object_relation.lazy_load.ghost.Department");
  ...
  private void loadTimeRecords(Employee employee) {
    ...
    loader.setMapper(MapperRegistry.mapper("object_relation.lazy_load.ghost.TimeRecord"));
