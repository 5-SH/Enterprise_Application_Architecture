...
public class DataSource {
  ...
  public static void init() {
    try {
      ...
      mapperRegistry.setMapper("object_relation.behavior.lazy_load.ghost.Employee", employeeMapper);
      mapperRegistry.setMapper("object_relation.behavior.lazy_load.ghost.Department", departmentMapper);
      mapperRegistry.setMapper("object_relation.behavior.lazy_load.ghost.TimeRecord", timeRecordMapper);
