...
public class ExclusiveReadLockManagerDBImpl implements ExclusiveReadLockManager {
  public static offline_concurrency.pessimistic_offline_lock.ExclusiveReadLockManager INSTANCE = new offline_concurrency.pessimistic_offline_lock.ExclusiveReadLockManagerDBImpl();
  ...
  public void releaseLock(Long lockable, String owner) throws Exception {
    try {
      Connection conn = offline_concurrency.pessimistic_offline_lock.ConnectionManager.getConnection();
